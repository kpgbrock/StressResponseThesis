function [copt,V,eps,emin,r2max,msr,phi0,seq] = pholderAggSAH(seq1,seq2)
...
% Subtract out average hydrophobicity
%seq = seq - mean(seq);
seq(1:n1) = seq(1:n1) - mean(seq(1:n1));
seq((n1+1):end) = seq((n1+1):end) - mean(seq((n1+1):end));
