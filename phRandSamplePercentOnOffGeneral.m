function [results] = phRandSamplePercentOnOffGeneral(nTrials,pID,numIntrxn,data)

setOfIntrxns = nchoosek(pID,2);
...
%     end
    lInt = setOfIntrxns(z,:);
    [temp] = phPercentageOnPredicatedGeneral(lInt,data);
    ...
    if (results.numOnToOff(i)/results.numOn7(i) > 1)
        disp(lInt);
    end
end
