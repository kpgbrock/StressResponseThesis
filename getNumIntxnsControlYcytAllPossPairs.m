function [results] =  getNumIntxnsControlYcytAllPossPairs(nIts,nRTS)
...
for i=1:nIts
    allPossPairs = nchoosek(pIdx(i,:),2);
    [iOn,iOff,iTotal,~,~,~,~] = countNumOnOffIntrxns(allPossPairs,pIdx(i,:)',phycfull); 
